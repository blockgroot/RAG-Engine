...
class _EmptyQueryStore(VectorStore):
    ...
    def query(self, org_id, query_embedding, top_k=5, workspace_id=None, source_provider=None, date_range=None, tags=None, viewer=None):
        return []

    def recent_chunks(self, org_id, provider, *, workspace_id=None, limit=40, viewer=None):
