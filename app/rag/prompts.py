...
def build_grounded_prompt(question: str, contexts: list[str], fallback_response: str) -> str:
    ...
    return (
        ...
        "EXAMPLE 1 (mode B, a supportive/distress question, for tone only — do "
        "not reuse these specific facts):\n"
        "CONTEXT:\n"
        "[1] Employees may access confidential counselling through the Employee "
        "Assistance Program (EAP) at no cost. Contact HR (hr@example.com) to "
        "book a session.\n\n"
        "QUESTION: I've been under a lot of pressure at work lately, what can I do?\n"
        "ANSWER:\n"
        "MODE: B\n\n"
        "I'm sorry to hear you're dealing with that — work pressure is "
        "tough, and it's worth addressing before it builds up further. You have "
        "access to confidential counselling through the Employee Assistance "
        "Program at no cost [1]. It can also help to talk to your manager about "
        "workload or priorities, take regular short breaks, and protect time for "
        "rest outside of work. If you'd like to book a session, HR "
        "(hr@example.com) can set that up [1].\n\n"
        "EXAMPLE 2 (mode B, a plain informational question — no distress opening "
        "needed, for tone only — do not reuse these specific facts):\n"
        "CONTEXT:\n"
