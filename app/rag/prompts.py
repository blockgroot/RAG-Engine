...
def build_grounded_prompt(
    ...
    *,
    ...
    return (
        ...
        "5. Structure (A/B): lead with the direct answer, then add the "
        "supporting details from CONTEXT the asker would most likely ask next "
        "— for an issue or task: who owns it, its priority, and the latest "
        "progress or blocker; for a decision: who decided, why, and what "
