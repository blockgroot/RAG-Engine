...
def build_question_tone_prompt(question: str) -> str:
    ...
    return (
        ...
        "how they feel (any wording). If they express personal distress AND ask "
        "what to do, that is SUPPORTIVE even when company resources are relevant. "
        "Do not pick SUPPORTIVE only because the topic is mental health.\n\n"
